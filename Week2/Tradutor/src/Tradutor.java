...
public class Tradutor {
	...
	public String traduzirFrase(String frase) {
		...
		return fraseTraduzida.trim(); //corta espaćos no inicio e fim da frase
	}

	private String primeiraTraducao(String palavra) {
		String traducao = traduzir(palavra);
		if(traducao.contains(","))
			traducao = traducao.substring(0, traducao.indexOf(",")); //corta a frase na virgula e captura a primeira parte
		return traducao;
	}
